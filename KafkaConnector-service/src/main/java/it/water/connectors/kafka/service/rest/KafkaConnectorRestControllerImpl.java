 ...
 * Rest Api Class for KafkaConnector entity.
 *
 */
@FrameworkRestController(referredRestApi = KafkaConnectorRestApi.class)
public class KafkaConnectorRestControllerImpl extends BaseEntityRestApi<KafkaConnector> implements KafkaConnectorRestApi {
    ...
    @Override
    protected BaseEntityApi<KafkaConnector> getEntityService() {
        return kafkaConnectorApi;
    }
    ...
    public Response addACLs(ACLConfig aclConfig) {
        log.debug("In REST Service POST /kafka/acls: {}", aclConfig);
        try {
    ...
    public Response deleteACLs(ACLConfig aclConfig) {
        log.debug("In REST Service DELETE /kafka/acls: {}", aclConfig);
        try {
